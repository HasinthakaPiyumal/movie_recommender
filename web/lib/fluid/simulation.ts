...
class Simulation {
  ...
  private handleMouseDown = (event: MouseEvent) => {
    let posX = this.scaleByPixelRatio(event.offsetX);
    let posY = this.scaleByPixelRatio(event.offsetY);
  ...
  private handleMouseMove = (event: MouseEvent) => {
    ...
    const posX = this.scaleByPixelRatio(event.pageX);
    const posY = this.scaleByPixelRatio(event.pageY);
